...
var txtAction = getUrlParameter('Action');
if (txtAction == 0) {
    $('html, body').animate({
        scrollTop: $("#tabZero").offset().top - 100
    }, 2000);
}
if (txtAction == 1) {
    $('html, body').animate({
        scrollTop: $("#tabOne").offset().top - 100
    }, 2000);
}
if (txtAction == 2) {
    $('html, body').animate({
        scrollTop: $("#tabTwo").offset().top - 100
    }, 2000);
}
if (txtAction == 3) {
    $('html, body').animate({
        scrollTop: $("#tabThree").offset().top - 100
    }, 2000);
}
if (txtAction == 4) {
    $('html, body').animate({
        scrollTop: $("#tabFour").offset().top - 100
    }, 2000);
}
if (txtAction == 5) {
    $('html, body').animate({
        scrollTop: $("#tabFive").offset().top - 100
    }, 2000);
}
if (txtAction == 6) {
    $('html, body').animate({
        scrollTop: $("#tabSix").offset().top - 100
    }, 2000);
}
if (txtAction == 7) {
    $('html, body').animate({
        scrollTop: $("#tabSeven").offset().top - 100
    }, 1000);
}
if (txtAction == 8) {
    $('html, body').animate({
        scrollTop: $("#tabEight").offset().top - 100
    }, 2000);
}
if (txtAction == 9) {
    $('html, body').animate({
        scrollTop: $("#tabNine").offset().top - 100
    }, 2000);
}
if (txtAction == 10) {
    $('html, body').animate({
        scrollTop: $("#tabTen").offset().top - 100
    }, 2000);
}
if (txtAction == 11) {
    $('html, body').animate({
        scrollTop: $("#tabEleven").offset().top - 100
    }, 2000);
}
if (txtAction == 12) {
    $('html, body').animate({
        scrollTop: $("#tabTwelve").offset().top - 100
    }, 2000);
}
if (txtAction == 13) {
    $('html, body').animate({
        scrollTop: $("#tabThirteen").offset().top - 100
    }, 2000);
}
if (txtAction == 99) {
    $("html, body").animate({
        scrollTop: $('#tabAA').offset().top + 100
        //scrollTop: $("#tabAA").offset().top
    }, 2000);
}