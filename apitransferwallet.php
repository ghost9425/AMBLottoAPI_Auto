...
<div class="wrapper container">
    ...
    <span class="hljs-attr">"msg"</span>: <span class="hljs-number">"success"</span>
                ...
                <div class="col-12" id="tabTen">
                    <lable><b style="color: #19A17A !important;" set-lan="text:3.2 Workflow">3.10 Update Password</b>
                    </lable>
                </div>
                <div class="pb-3"></div>
                <div class="btn-toolbar mb-3" role="toolbar">
                    <div class="divBox">
                        ...
                        <div class="col-12">
                            ...
                            <label>
                                https://test-api.pirate168.com/apiRoute/member/landing/update/password
                            </label>
                        </div>
                        <div class="col-12">
                            <label class="txtHead">
                            ...
                            <div class="table-wrapper">
                                <table class="table table-borderless table-striped" id="DataTable1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="bRight">old_password</td>
                                            <td class="bRight">String</td>
                                            <td class="bRight">Password for login.</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="bRight">confirm_password</td>
                                            <td class="bRight">String</td>
                                            <td class="bRight">Confirm password match new password</td>
                                        </tr>
                                        <tr>
                                            <td class="bRight">agent</td>
                                            <td class="bRight">String</td>
                    ...
                    <div class="koh-tab-content col-12">
                        <div class="koh-tab-content-body">
                            <div class="koh-faq form-group">
                                ...
                                <div class="koh-faq-answer col-9">
                                    <pre><code id="45A" style="border-radius: 0.375rem;" class="hljs json">{
    <span class="hljs-attr">"username"</span>: <span class="hljs-string">"ntest11",</span>
    <span class="hljs-attr">"old_password"</span>: <span class="hljs-string">"aA123456",</span>
    <span class="hljs-attr">"new_password"</span>: <span class="hljs-string">"aA444444",</span>
    <span class="hljs-attr">"confirm_password"</span>: <span class="hljs-string">"aA444444",</span>
                        ...
                        <div class="table-wrapper">
                            <table class="table table-borderless table-striped" id="DataTable45C">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="bRight">2031</td>
                                        <td>new_password_equal_old_password</td>
                                    </tr>
                                    <tr>
                                        <td class="bRight">2031</td>
                                        <td>invalid_old_password</td>
                                    </tr>
                                    <tr>
                                        <td class="bRight">2031</td>
                                        <td>password len is < 8</td>
                                    ...
                                    <tr>
                                        <td class="bRight">2058</td>
                                        <td>invalid confirm password</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    <span class="hljs-attr">"message"</span>: <span class="hljs-number">"update password success"</span>
                ...
                <div class="col-12" id="tabEleven">
                    <lable><b style="color: #19A17A !important;" set-lan="text:3.2 Workflow">3.11 Update Password No-Address</b>
                    </lable>
                </div>
                <div class="pb-3"></div>
                <div class="btn-toolbar mb-3" role="toolbar">
                    <div class="divBox">
                        ...
                        <div class="col-12">
                            ...
                            <label>
                                https://test-api.pirate168.com/apiRoute/member/landing/update/password/noaddress
                            </label>
                        </div>
                        <div class="col-12">
                            <label class="txtHead">
                    ...
                    <div class="koh-tab-content col-12">
                        <div class="koh-tab-content-body">
                            <div class="koh-faq form-group">
                                ...
                                <div class="koh-faq-answer col-9">
                                    <pre><code id="45A" style="border-radius: 0.375rem;" class="hljs json">{
    <span class="hljs-attr">"username"</span>: <span class="hljs-string">"ntest10@ntc123",</span>
    <span class="hljs-attr">"old_password"</span>: <span class="hljs-string">"aA123456",</span>
    <span class="hljs-attr">"new_password"</span>: <span class="hljs-string">"aA444444",</span>
    <span class="hljs-attr">"confirm_password"</span>: <span class="hljs-string">"aA444444",</span>
    <span class="hljs-attr">"agent"</span>: <span class="hljs-string">"ntc123"</span>
